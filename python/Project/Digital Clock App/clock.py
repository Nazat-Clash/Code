...
def clock(format=None):
    ...
    This module provides a simple digital clock that can display the local time in either 12-hour or 24-hour format.
...
def info():
    ...
    This module provides a simple digital clock that can display the current local time in either 12-hour or 24-hour format.
